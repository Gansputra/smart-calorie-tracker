...
<body class="bg-slate-50 font-sans antialiased">
    ...
    <div class="dashboard-shell">
        ...
        <!-- Sidebar -->
        <aside id="app-sidebar" class="dashboard-sidebar app-sidebar">
            <!-- Logo -->
        ...
        <div class="dashboard-main">
            ...
            <header class="sticky top-0 z-30 bg-white border-b border-slate-100 px-4 lg:px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <span class="hidden sm:inline text-sm text-slate-500 mr-1">{{ now()->translatedFormat('l, d F Y') }}</span>
                        ...
                        @if(auth()->user()->hasRole('admin'))
                            <a href="{{ route('admin.dashboard') }}" class="btn-secondary btn-sm text-xs">
